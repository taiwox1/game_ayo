    ...
    <div className=" flex flex-col bg-[url('/home/adedotun/game_ayo/src/assets/bag.gif')] bg-cover bg-center h-screen w-screen ">
      ...
      <div className=" flex flex-col items-center ">
        <div className=" flex flex-col mx-auto pb-4 my-4 bg-[#795548] shadow-2xl w-[260px] md:w-[400px] md:h-[480px] rounded-xl">
          <div className=" flex flex-col shadow-2xl bg-[url('/home/adedotun/game_ayo/src/assets/ayoii.jpeg')] bg-cover mb-auto sm:w-[100%] h-[180px] md:h-[250px] rounded-xl">
          ...
          <div className="flex flex-row   justify-between mt-[40px] bg-gray-300 p-4 mx-2 md:mx-4 rounded-xl h-[80px]">
            <button
              onClick={() => {
                setState("create");
              }}
              ...
              } p-2 mr-2  shadow-xl rounded-2xl font-semibold text-[14px]  md:text-[20px] h-[40px] w-[110px] md:h-[50px]  md:w-[150px]`}
            >
              Create Game
            </button>
            <button
